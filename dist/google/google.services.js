...
exports.updateQuestionByAI = exports.getGeminiExplanation = exports.askGemini = exports.getChapterAndSubjectScores = exports.isUserLegibleForAiAsk = void 0;
const prisma_1 = __importDefault(require("../utils/prisma"));
const google_schema_1 = require("./google.schema");
const google_model_1 = require("./google.model");
const google_methods_1 = require("./google.methods");
...
const askGemini = (userId, prompt) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield google_model_1.model.generateContent(prompt);
...
const getGeminiExplanation = (data) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  <br/>
    ...
    **Important Guidelines for Generation:**
    ...
    `;
        const result = yield google_model_1.model.generateContent(prompt);
        return (0, google_methods_1.truncatedGenAiOutput)(result.response.text());
    }
    catch (error) {
...
const updateQuestionByAI = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id, question, options, answer, message } = data;
        const prompt = `
        Parse the following message to extract the question, options (A, B, C, D), and the correct answer. Then, generate a comprehensive explanation for the correct answer in pure HTML format, following the specified structure. Finally, format all of this information into a JSON object as described below.

        Here is the question: "${question} ${Object.entries(options).map(([key, value]) => `${key.toUpperCase()}) ${value}`).join(' ')} Answer: ${answer}"
        And here is what the user reported: "${message}"
        ...
        \`\`\`json
        {
          ...
          "answer": "a|b|c|d",
          "explanation": "string" // This string must contain the HTML explanation generated by you.
        }
        \`\`\`

        HTML Explanation Guidelines (must be embedded in the 'explanation' field):
      `;
        const result = yield google_model_1.model.generateContent(prompt);
...
exports.updateQuestionByAI = updateQuestionByAI;
